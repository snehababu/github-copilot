...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["logan@mergington.edu", "bryan@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Skill development and pickup games for basketball enthusiasts",
    ...
    "Drama Club": {
        "description": "Acting workshops, rehearsals, and theatrical productions",
